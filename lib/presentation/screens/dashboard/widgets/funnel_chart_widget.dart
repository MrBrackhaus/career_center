...
class FunnelChartWidget extends StatelessWidget {
  ...
  const FunnelChartWidget({Key? key, required this.stages}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    ...
    if (maxValue == 0) {
      return const Center(child: Text('Noch nicht genügend Daten für den Funnel.'));
    }
            ...
            return Column(
              children: [
                ...
                AnimatedContainer(
                  ...
                  height: 48,
                  decoration: BoxDecoration(
                    color: width > 0 ? stage.color : Colors.grey.withOpacity(0.1),
