              ...
              Padding(
                ...
                child: Row(
                  children: [
                    ...
                    _Legend(
                      color: Colors.purple,
                      label: AppLocalizations.of(context)!.formBasicInterview,
                    ),
                    ...
                    return Row(
                      ...
                      children: appsOnDay.take(3).map((app) {
                        ...
                        if (app.status == 'interview') {
                          color = Colors.purple;
                        } else if (app.followupDate != null &&
                            app.followupDate!.isBefore(now)) {
                          color = Colors.red;
                        } else {
                          color = Colors.orange;
                        }
                  ...
                  child: ListView.builder(
                    ...
                    itemBuilder: (ctx, i) {
                      ...
                      final isOverdue =
                          ...
                          app.followupDate!.isBefore(DateTime.now());
                      return Card(
                        child: ListTile(
