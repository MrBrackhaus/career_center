...
Future<void> seedTextbausteine(AppDatabase db) async {
  final templates = [
    ...
    TemplatesCompanion.insert(name: 'Gehaltsvorstellung', type: 'textbaustein', content: drift.Value('[{\"insert\":\"Meine Gehaltsvorstellungen liegen bei einem Bruttojahresgehalt von XY Euro. Ein Einstieg ist ab dem [Datum] möglich.\\n\"}]')),
